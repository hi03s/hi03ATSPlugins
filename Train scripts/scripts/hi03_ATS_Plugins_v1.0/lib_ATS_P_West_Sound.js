...
2.onUpdate(su) の中に operationATS_P_West(su); を記述します
3.ユーザー設定で再生する音声の割当を設定します
*/

var ATS_P_West_SoundManager = new java.util.WeakHashMap();
function operationATS_P_West(su, settings) {
    ...
    var state = function () {
        ...
        return {
            ...
            isAtsFault: dm.getBoolean("ATS-P_West_isAtsFault"),                 //Ps故障
    ...
    //サウンド登録
    var isPlayingSound = {};
    var prevPlayingSound = ATS_P_West_SoundManager.get(entity) || {};
    ...
    //フラグ保存
    ATS_P_West_SoundManager.put(entity, isPlayingSound);
}